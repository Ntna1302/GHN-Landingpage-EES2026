...
>
  ...
  />
  <span className="ghn-logo-text" style={{ color: "#006FAD", fontSize: "2.15rem" }}>× EES <span style={{ color: "#FF5200", fontSize: "2.15rem" }}>2026</span></span>
</div>
